...
Rails.application.config.assets.precompile += %w( http://d3js.org/d3.v3.js )
Rails.application.config.assets.precompile += %w( nv.d3.min.css )
Rails.application.config.assets.precompile += %w( nv.d3.min.js )
Rails.application.config.assets.precompile += %w( http://cdnjs.cloudflare.com/ajax/libs/dc/1.7.5/dc.min.js )
Rails.application.config.assets.precompile += %w( http://cdnjs.cloudflare.com/ajax/libs/dc/1.7.5/dc.min.css )
Rails.application.config.assets.precompile += %w( crossfilter.js )
